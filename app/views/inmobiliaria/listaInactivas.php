...
<body>
                            ...
                            <?php foreach ($propiedades as $propiedad): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        |
                                        <button class="btn"
                                            onclick="abrirPopup('activar',<?= htmlspecialchars(json_encode($propiedad)); ?>)">Activar</button>
                                        |
                                        <button class="btn"
    ...
    <script>
        function abrirPopup(tipo, data) {
            ...
            if (tipo === 'activar') {
                body.innerHTML = `
            <h2>Activar Propiedad</h2>
            <p>¿Estás seguro de que deseas activar esta propiedad?</p>
